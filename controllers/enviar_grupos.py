...
from services.enviar_grupos_service import enviar_mensaje_whatsapp_a_grupos
from utils.driver import abrir_navegador

def ComponenteEnviarGrupos(page: ft.Page):
    ...
    def enviar_click(e):
        componentes["instrucciones"].value = "📨 Enviando mensajes a grupos..."
        ...
        try:
            enviar_mensaje_whatsapp_a_grupos(
                ruta_csv,
                ruta_txt,
                driver,
            ...
            componentes["instrucciones"].value = "✅ Mensajes enviados a grupos correctamente."
    ...
    return ft.Column([
        ft.Text("Enviar a grupos", size=20),
